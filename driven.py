...
class DriveSim:
    def __init__(self, gearbox, **kwargs):
        ...
        self.periodic_period = 0.01 # called on 10 ms intervals
    ...
    def calculate_acceleration(self, v, gbox_torque, slip):
        ...
        linear_force = ground_on_gbox_force * self.gearbox_count - rolling_resistance
        return linear_force / self.robot_mass_kg, slip
    ...
    def run_sim(self, timeout_s=3, sample_rate=None):
        ...
        while self.i < len(self.ts):
            a, slip = self.calculate_acceleration(v, gbox_torque, slip)
